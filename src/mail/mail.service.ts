...
<!--<![endif]-->
<table class=t37 role=presentation cellpadding=0 cellspacing=0 width=100% style="width:100%;"><tr><td class=t36 style="padding:30px 20px 20px 20px;"><table role=presentation width=100% cellpadding=0 cellspacing=0 style="width:100% !important;"><tr><td align=center>
...
<!--[if mso]>
<td width=154 class=t21 style="background-color:#ff7235;overflow:hidden;width:154px;border-radius:8px 8px 8px 8px;">
<![endif]-->
<!--[if !mso]>-->
<td class=t21 style="background-color:#ff7235;overflow:hidden;width:154px;border-radius:8px 8px 8px 8px;">
<!--<![endif]-->
<table class=t20 role=presentation cellpadding=0 cellspacing=0 width=100% style="width:100%;"><tr><td class=t19 style="text-align:center;line-height:40px;mso-line-height-rule:exactly;mso-text-raise:8px;"><a class=t17 href="${verificationLink}" style="display:block;margin:0;Margin:0;font-family:Inter,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:40px;font-weight:700;font-style:normal;font-size:15px;text-decoration:none;letter-spacing:-0.5px;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:8px;" target="_blank"  >Verifikasi akun saya</a></td></tr></table>
